            ...
            if (layEvent === 'detail') { //查看
                ...
                layer.open({
                    ...
                    ,yes: function(index, layero){
                        //通过以下的方法获取回调的数值
                        var medicine_id = $(layero).find('iframe')[0].contentWindow.medicine_id.value;
                        var medicine_name = $(layero).find('iframe')[0].contentWindow.medicine_name.value;
                        var medicine_price = $(layero).find('iframe')[0].contentWindow.medicine_price.value;
                        var medicine_quantity = $(layero).find('iframe')[0].contentWindow.medicine_quantity.value;
                    ...
                    ,success: function(layero, index){
                        ...
                        body.find("#medicine_id").val(data.medicine_id);
                        body.find("#medicine_name").val(data.medicine_name)
                        body.find("#medicine_price").val(data.medicine_price)
                        body.find("#medicine_quantity").val(data.medicine_quantity)
